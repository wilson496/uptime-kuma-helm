...
This is a fork of the original project seen link:https://github.com/k3rnelpan1c-dev/uptime-kuma-helm[here]. Changes will include a Fluentbit sidecar for sending STDOUT logs from Uptime Kuma as well as the route/ingress enabled by default. 
...
----
helm repo add k3 https://wilson496.github.io/uptime-kuma-helm/
helm repo update
----
